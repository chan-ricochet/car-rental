...
class BooksModel {
    ...
    function getBooks($limit = 10) {
        try {
            ...
            show_error('Error while fetching car details: ' . $ex->getMessage(), 500);
        }
    }
    ...
    function getBook($id) {
        try {
            ...
            show_error('Error while fetching car with ID: ' . $id . $ex->getMessage(), 500);
        }
    }
    ...
    function insertBook($title, $author, $pages) {
        try {
            ...
            show_error('Error while adding car entry : ' . $ex->getMessage(), 500);
        }
    }
